...
{
	internal class ExportLinearNetworksCommand : ExchangeLinearNetworksCommand<LinearNetworksItem>
	{
		private static readonly Image _image = Resources.Export;

		private readonly bool _filterByModel;

		public ExportLinearNetworksCommand([NotNull] LinearNetworksItem item,
		...
		protected override void ExecuteCore()
		{
			...
			using (var dialog = new SaveFileDialog())
			{
				...
				{
					Item.ExportNetworks(xmlFilePath, model);
				}
			}
		}

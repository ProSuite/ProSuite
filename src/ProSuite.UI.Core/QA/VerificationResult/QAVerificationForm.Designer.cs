...
namespace ProSuite.UI.Core.QA.VerificationResult
{
    partial class QAVerificationForm
    {
        ...
        private void InitializeComponent()
        {
			...
			//
			// Dock=Fill replaces the old Anchor+Location pattern, which breaks in .NET Core
			// when mixed with Dock=Top/_statusStrip on the same form.
			this._splitContainerDetail.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			//
			// _panelHeader — Dock=Top keeps all header controls in a predictable container
			// so the right-anchored controls inside resolve against the panel width (= form
			// client width) rather than against the form directly, which is unreliable in
			// .NET Core when mixed with other docked controls on the same form.
			//
			this._panelHeader.Controls.Add(this._textBoxWarningCount);
			this._panelHeader.Controls.Add(this._labelSoftErrors);
			this._panelHeader.Controls.Add(this._textBoxErrorCount);
			this._panelHeader.Controls.Add(this._labelHardErrors);
			this._panelHeader.Controls.Add(this._textBoxVerificationStatus);
			this._panelHeader.Controls.Add(this._textBoxIssueCount);
			this._panelHeader.Controls.Add(this._labelTotalErrors);
			this._panelHeader.Controls.Add(this._labelTotalTime);
			this._panelHeader.Controls.Add(this._textBoxTotalTime);
			this._panelHeader.Controls.Add(this._textBoxCPUTime);
			this._panelHeader.Controls.Add(this._labelProcessorTime);
			this._panelHeader.Controls.Add(this._labelEnded);
			this._panelHeader.Controls.Add(this._textBoxEndDate);
			this._panelHeader.Controls.Add(this._textBoxStartDate);
			this._panelHeader.Controls.Add(this._labelStartDate);
			this._panelHeader.Controls.Add(this._labelOperator);
			this._panelHeader.Controls.Add(this._textBoxUser);
			this._panelHeader.Controls.Add(this._textBoxContext);
			this._panelHeader.Controls.Add(this._labelContext);
			this._panelHeader.Controls.Add(this._textBoxDescription);
			this._panelHeader.Controls.Add(this._labelDescription);
			this._panelHeader.Controls.Add(this._textBoxSpecification);
			this._panelHeader.Controls.Add(this._labelSpecification);
			this._panelHeader.Dock = System.Windows.Forms.DockStyle.Top;
			this._panelHeader.Name = "_panelHeader";
			this._panelHeader.Size = new System.Drawing.Size(911, 157);
			this._panelHeader.TabIndex = 28;
			//
			// QAVerificationForm
			//

...
namespace ProSuite.QA.TestFactories
{
	[UsedImplicitly]
	[GeometryTest]
	public class QaMaxAreaFactory : QaLinearUnitFactory
	{
		[NotNull]
		[UsedImplicitly]
		public static ITestIssueCodes Codes
		{
			get { return QaMaxArea.Codes; }
		}

		public QaMaxAreaFactory() : base(typeof(QaMaxArea), 0, typeof(AreaUnits))
		{
			// Constructor
			//new QaMaxArea(table,limit)
		}

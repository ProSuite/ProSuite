		...
		var result = new PartialReshapeAlongOptions
		             {
			             ...
			             // Reshape line filter settings
			             ExcludeLinesOutsideToleranceOfSource =
				             TryClone(ExcludeLinesOutsideToleranceOfSource),
			             ExcludeLinesOutsideSourceTolerance =
				             TryClone(ExcludeLinesOutsideSourceTolerance),
			             ShowExcludeLinesOutsideSourceToleranceBuffer =
				             TryClone(ShowExcludeLinesOutsideSourceToleranceBuffer),
			             ExcludeLinesOutsidePolygonSource =
				             TryClone(ExcludeLinesOutsidePolygonSource),
			             ExcludeLinesResultingInTargetOverlaps =
				             TryClone(ExcludeLinesResultingInTargetOverlaps),

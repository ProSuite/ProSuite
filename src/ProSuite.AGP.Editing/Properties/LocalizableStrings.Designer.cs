...
namespace ProSuite.AGP.Editing.Properties {
    ...
    internal class LocalizableStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Select one or more line or polygon features to align with other feature(s). &lt;br&gt;- Press and hold SHIFT to add or remove features from the existing selection. &lt;br&gt;- Press and hold P to draw a polygon that completely contains the features to be selected. Finish the polygon with double-click.&lt;br&gt;- Press [S] to toggle the reshape side..
        /// </summary>

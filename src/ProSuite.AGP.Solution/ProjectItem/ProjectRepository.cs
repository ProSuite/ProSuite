...
namespace ProSuite.AGP.Solution.ProjectItem
{
	public class ProjectRepository
	{
		...
		public static ProjectRepository Current =>
			_repository ?? (_repository = new ProjectRepository());
		...
		public bool AddProjectFileItems(ProjectItemType itemType,
		                                [NotNull] IEnumerable<string> filesPath)
		{
			ProjectFileRepository fileRepo = InitRepository(itemType);
			if (fileRepo != null)
			{
		...
		public bool DeleteProjectFileItems(ProjectItemType itemType,
		                                   [NotNull] IEnumerable<string> filesPath)
		{
			ProjectFileRepository fileRepo = InitRepository(itemType);
			if (fileRepo != null)

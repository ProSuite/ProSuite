...
/// <summary>
/// Utils for WPF keyboard input. See ProSuite.Commons.UI.Keyboard.<see cref="ProSuite.Commons.UI.Keyboard.KeyboardUtils"/>
...
public static class KeyboardUtils
{
	...
	/// <param name="exclusive">Only one modifier key exclusively down.

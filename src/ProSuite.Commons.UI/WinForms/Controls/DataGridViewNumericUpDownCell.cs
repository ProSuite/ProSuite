...
namespace ProSuite.Commons.UI.WinForms.Controls
{
	...
	public class DataGridViewNumericUpDownCell : DataGridViewTextBoxCell
	{
		...
		private static readonly DataGridViewContentAlignment _anyRight =
			DataGridViewContentAlignment.TopRight |
			DataGridViewContentAlignment.MiddleRight |
			DataGridViewContentAlignment.BottomRight;

		private static readonly DataGridViewContentAlignment _anyCenter =
			DataGridViewContentAlignment.TopCenter |
			DataGridViewContentAlignment.MiddleCenter |
			DataGridViewContentAlignment.BottomCenter;

		// Default dimensions of the static rendering bitmap used for the painting of the non-edited cells
		private const int _defaultRenderingBitmapWidth = 100;
		private const int _defaultRenderingBitmapHeight = 22;
		...
		internal const decimal DATAGRIDVIEWNUMERICUPDOWNCELL_defaultIncrement =
			decimal.One;

		// Default value of the Maximum property
		internal const decimal DATAGRIDVIEWNUMERICUPDOWNCELL_defaultMaximum =
			(decimal) 100.0;
		...
		internal const bool DATAGRIDVIEWNUMERICUPDOWNCELL_defaultThousandsSeparator =
			false;

		// Type of this cell's editing control
		private static readonly Type _defaultEditType =
		...
		public DataGridViewNumericUpDownCell()
		{
			...
			{
				_renderingBitmap =
					new Bitmap(_defaultRenderingBitmapWidth,
					           _defaultRenderingBitmapHeight);
			}

			// Create a thread specific NumericUpDown control used for the painting of the non-edited cells
			if (_paintingNumericUpDown == null || _paintingNumericUpDown.IsDisposed)
			{
		...
		public override Type EditType =>
			_defaultEditType; // the type is DataGridViewNumericUpDownEditingControl
		...
		public decimal Increment
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException(
						nameof(value), @"The Increment property cannot be smaller than 0.");
				}
		...
		/// </summary>
		private static Rectangle GetAdjustedEditingControlBounds(
		                                                ...
		                                                int rowIndex)
		{
			...
			Rectangle errorIconBounds =
				base.GetErrorIconBounds(graphics, cellStyle, rowIndex);
		                                            ...
		                                            DataGridViewDataErrorContexts context)
		{
			...
			if (! string.IsNullOrEmpty(formattedNumber) && value != null)
			{
				...
				if (unformattedDecimal == formattedDecimal)
				{
					...
					return formattedDecimal.ToString((ThousandsSeparator
						                                  ? "N"
						                                  : "F") +
					                                 DecimalPlaces);
				}
		                              ...
		                              DataGridViewPaintParts paintParts)
		{
			...
			if (_paintingNumericUpDown.IsDisposed)
			{
				return;
			}
			...
			if (! cellEdited)
			{
				if (PartPainted(paintParts, DataGridViewPaintParts.ContentForeground))
				{
					...
					bool cellSelected = (cellState & DataGridViewElementStates.Selected) !=
					                    0;
					...
					if (_paintingNumericUpDown.Parent == null ||
					    ! _paintingNumericUpDown.Parent.Visible)
					{
						_paintingNumericUpDown.Parent = DataGridView;
					}

					// Set all the relevant properties
					_paintingNumericUpDown.TextAlign =
						TranslateAlignment(cellStyle.Alignment);
					...
					_paintingNumericUpDown.Location =
						new Point(0, -_paintingNumericUpDown.Height - 100);
					_paintingNumericUpDown.Text = formattedValue as string;

					Color backColor;
					if (
						PartPainted(paintParts, DataGridViewPaintParts.SelectionBackground) &&
						cellSelected)
					{
					...
					if (srcRect.Width > 0 && srcRect.Height > 0)
					{
						...
						graphics.DrawImage(_renderingBitmap,
						                   new Rectangle(valBounds.Location,
						                                 valBounds.Size),
		                                            ...
		                                            bool isFirstDisplayedRow)
		{
			...
			DataGridView.EditingControl.Size =
		...
		/// </summary>
		internal static HorizontalAlignment TranslateAlignment(

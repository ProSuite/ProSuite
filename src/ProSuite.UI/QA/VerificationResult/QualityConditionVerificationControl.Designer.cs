namespace ProSuite.UI.QA.VerificationResult
{
    partial class QualityConditionVerificationControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this._qualityConditionControl = new ProSuite.UI.QA.Controls.QualityConditionControl();
			...
			this._qualityConditionTableViewControl = new ProSuite.UI.QA.Controls.QualityConditionTableViewControl();
			this._tabPageTestDescriptor = new System.Windows.Forms.TabPage();
			this._testDescriptorControl = new ProSuite.UI.QA.Controls.TestDescriptorControl();
        ...
        private ProSuite.UI.QA.Controls.QualityConditionControl _qualityConditionControl;
    	private ProSuite.UI.QA.Controls.TestDescriptorControl _testDescriptorControl;
		...
		private ProSuite.UI.QA.Controls.QualityConditionTableViewControl _qualityConditionTableViewControl;
	}
}

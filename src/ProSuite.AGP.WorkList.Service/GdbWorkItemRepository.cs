...
//		public IEnumerable<KeyValuePair<WorkItem, IReadOnlyList<Coordinate3D>>> GetItems(
...
//					// todo daro: cache?
//					yield return new KeyValuePair<WorkItem, IReadOnlyList<Coordinate3D>>(item, coordinates);
//				}
//			}
//		}

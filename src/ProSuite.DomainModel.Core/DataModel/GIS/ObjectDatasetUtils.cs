...
{
	/// <summary>
	/// Provides GIS-specific functionality for domain datasets
	/// </summary>
	public static class ObjectDatasetUtils
	{
		                                               ...
		                                               [NotNull] IObject ofObject)
		{
			...
			int subtypeFieldIndex = DatasetUtils.GetSubtypeFieldIndex(ofObject.Class);
			...
			object value = ofObject.get_Value(subtypeFieldIndex);
		                              ...
		                              [NotNull] IObjectDataset objectDataset)
		{
			...
			return AttributeUtils.GetValueFor(obj, attribute);
		}
		                            ...
		                            bool allowMissingRole = false)
		{
			...
			int fieldIndex = AttributeUtils.GetFieldIndex(obj.Class, attribute);
		                             ...
		                             [NotNull] IObjectDataset objectDataset)
		{
			...
			int fieldIndex =
				AttributeUtils.GetFieldIndex(obj.Class, uuidAttribute);
			if (fieldIndex < 0)
			{
				return string.Empty;
			}
			...
			var guidString = obj.get_Value(fieldIndex) as string;

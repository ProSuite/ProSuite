...
{
	// TODO: Merge with ProSuite.DomainModel.AO.QA.RowParser
	public static class InvolvedRowParser
	{
		...
		[NotNull]
		public static IEnumerable<InvolvedRow> Parse([NotNull] string involvedObjectsString)
		{
